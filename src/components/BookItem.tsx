...
function BookItem (props: BookItemProps) {
    ...
    return (
        <article className="border-2 border-custom-bg my-3 w-[200] md:w-45 md:h-[550px] rounded-md bg-emerald-100 flex flex-col ">
            <div className="w-25 md:w-45 h-[200px] md:h-[350px] aspect-[2/3] overflow-hidden"> 
                <img className= "mb-3 w-full h-full object-cover flex m-auto my-2 p-3 rounded-xl" src= {book?.photo || '/img/portadaVacia.png'} alt= {`Portada del libro ${book.title}`}/>
            </div>
